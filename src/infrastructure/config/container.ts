...
import { EventPublisherPort } from '../../application/ports/output/EventPublisherPort';
...
// External Services
container.bind<TokenServicePort>('TokenServicePort').to(JwtTokenService);
container.bind<PasswordServicePort>('PasswordServicePort').to(BcryptPasswordService);
container.bind<EmailServicePort>('EmailServicePort').to(EmailService);
container.bind<EventPublisherPort>('EventPublisherPort').to(RabbitMQEventPublisher);
...
container.bind<AuthCommandPort>('AuthCommandPort').to(AuthApplicationService);
container.bind<AuthQueryPort>('AuthQueryPort').to(AuthApplicationService);
